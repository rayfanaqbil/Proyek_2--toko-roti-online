...
@section('content')
	<!-- header end -->
	<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('themes/ezone/assets/img/bg/keranjang.jpg') }})">
		<div class="container">
						...
						<div class="row">
							<div class="col-md-5 ml-auto">
								<div class="cart-page-total">
									...
									<a href="{{ url('orders/checkout') }}">Proses checkout</a>
								</div>
							</div>
						</div>
                        </form>
