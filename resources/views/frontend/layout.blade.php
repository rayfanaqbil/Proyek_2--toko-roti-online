                ...
                <div class="services-wrapper">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            ...
                            <p>Pastikan Barang Anda Tiba dengan Cepat dan Aman. </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>Kontak Kami Selalu Terbuka 24 Jam. </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>Proses Pembayaran yang Aman dan Terjamin. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-about-2">
                                <p>Kunjungi www.cornerbakery.com untuk menjelajahi<br> kelezatan dari sudut kota yang kini hadir di ujung jari Anda.<br> Temukan menu interaktif, pesan online,<br> dan tetap up-to-date dengan berita terbaru. Kunjungi<br> sekarang dan buka pintu ke dunia rasa Corner Bakery!</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jl.Sukasari <br>Bandung - blok 26</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> cornerbakery@gmail.com</a> <br><a href="#"> corneradmin@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
