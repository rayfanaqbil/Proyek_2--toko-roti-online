...
@section('content')
    <div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('themes/ezone/assets/img/bg/produk.jpg') }})">
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="product-wrapper mb-30">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <p>Stok: {{ optional($product->productInventory)->qty }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end -->
                                                ...
                                                <div class="product-wrapper mb-30 single-product-list product-list-right-pr mb-60">
                                                    ...
                                                    <div class="product-content-list">
                                                        <div class="product-list-info">
                                                            ...
                                                            <p>Jumlah: {{ optional($product->productInventory)->qty }}</p> <!-- Menampilkan jumlah -->
                                                        </div>
