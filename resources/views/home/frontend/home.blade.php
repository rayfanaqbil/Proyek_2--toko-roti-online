...
<div class="container mt-5">
    <div class="row">
        <div class="col-sm-9 mx-auto">
            ...
            <div class="product">
                <center>
                <h4 class="mb-4"><b>Produk Terlaris</b></h4>
                </center>
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="official-content">
                            <h4><b>Cornery Bakery</b></h4>
                            <p>kami memiliki 1 toko yang tersebar di seluruh Bandung dan akan terus berkembang</p>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <img src="{{ asset('assets/img/toko_kue.jpg') }}" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
